        ...
        {currentTabs === "RESUME" && (
          <div className="mt-10">
            ...
            <div className="mt-10">
              ...
              <hr className="my-10"></hr>
              <div className="flex">
                <label className="w-1/5 text-lg opacity-50">Concepts</label>
                <div className="w-4/5 ml-10 flex flex-col">
                  {data.resume.concepts.map((other, index) => (
                    <div key={index} className="flex">
                      <input
                        value={other}
                        onChange={(e) => {
                          setData({
                            ...
                            resume: {
                              ...data.resume,
                              concepts: [
                                ...data.resume.concepts.slice(0, index),
                                e.target.value,
                                ...data.resume.concepts.slice(index + 1),
                              ],
                            },
                          });
                        }}
                      ...
                      <Button
                        onClick={() =>
                          setData({
                            ...
                            resume: {
                              ...data.resume,
                              concepts: data.resume.concepts.filter(
                                (value, i) => index !== i
                              ),
                            },
                          })
                  ...
                  <Button
                    onClick={() =>
                      setData({
                        ...
                        resume: {
                          ...data.resume,
                          concepts: [...data.resume.concepts, "Added"],
                        },
                      })
                    }
                    type="primary"
